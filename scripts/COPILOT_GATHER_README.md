...
Token Usage:
  Input Tokens:          278700 ($0.8361)
  Output Tokens:         6500 ($0.0975)
  Cache Write Tokens:    253100 ($0.7593)
  Total Tokens:          285200
...
| **Input Tokens** | Input tokens sent to the model with cost |
| **Output Tokens** | Output tokens generated by the model with cost |
| **Cache Write Tokens** | Tokens written to prompt cache with cost (charged at input rate) |
| **Total Tokens** | Total tokens (Input + Output) |
...
4. Calculates costs based on current pricing:
   - **Sonnet 4.5**: $3.00 input, $15.00 output per 1M tokens
   - **Opus 4.5**: $15.00 input, $75.00 output per 1M tokens
   - **Haiku 4.0**: $0.80 input, $4.00 output per 1M tokens
   - **Cache Write**: Charged at standard input rate
5. Logs everything with detailed cost breakdown
